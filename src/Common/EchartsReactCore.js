...
import isEqual from 'fast-deep-equal'; // 深度比较chart的options数据是否发生改变
import { bind, clear } from 'size-sensor'; // 用来监听dom的size是否发生改变
...
export default class EchartsReactCore extends BaseComponent {
  constructor(props) {
    super(props);
